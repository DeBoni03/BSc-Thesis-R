...
In this repository the R code used in this study is shared alongside a synthetic dataset useful for testing the script. 

The provided code is divided in the following sections:
1. Preprocessing and Data Cleaning
2. K-Means
3. Hierarchical Methods
4. DBSCAN
5. Mismatch and CVI Analysis
6. PERMANOVA

The complete study is available here: https://hdl.handle.net/20.500.12608/106062
